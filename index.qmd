...
format:
  revealjs: 
    ...
    chalkboard: 
      buttons: false
    preview-links: auto
    logo: images/logos/hpi_logo_cropped.svg
    css: styles.css
    footer: 'Thesis Defense Robin P. van de Water'
    theme: serif
...
-   Presenting code and LaTeX equations [@schadow1999units]
-   Including computations in slide output render [@chishtieUseEpicElectronic2023]
