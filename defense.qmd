...
::: {.incremental}
-  **Despite the promise and explosion of AI and machine learning research, few models have been successfully deployed in clinical practice.** ^[[@apellExplainingSlowAdoption2026] [@henzlerHealthcareProfessionalsPerspectives2025]]
- Why?

  ⚡ **<span data-id="problem-repro">Research reproducibility</span>**: Different papers report different performance for the same task due to variations in datasets, preprocessing, and evaluation.^[[@futomaMythGeneralisabilityClinical2020]]

  ⚡ **<span data-id="problem-incomplete">Incomplete observations</span>**: Retrospective data does not necessarily reflect the information needed for clinical decision-making. ^[[@agnielBiasesElectronicHealth2018]]

  ⚡ **<span data-id="problem-infrastructure">Lack of robust infrastructure</span>**: Each institution builds their own custom solutions, making it hard to share research results and validate across sites.^[[@mcdermottLackScienceMachine2025] [@donohoDataScienceSingularity2024]]
...
1. ⚡ **<span data-id="problem-repro">Research reproducibility</span>** <span class="fragment fade-in" data-fragment-index="1" data-id="repro-phrase">→ Enabling Reproducible Prediction Experiments 🧪</span>
2. ⚡ **<span data-id="problem-incomplete">Incomplete observations</span>**  <span class="fragment fade-in" data-fragment-index="2" data-id="incomplete-phrase">→ Development of Multi-ward Multi-modal Warning Systems 🛏️​</span>
3. ⚡ **<span data-id="problem-infrastructure">Lack of infrastructure</span>**  <span class="fragment fade-in" data-fragment-index="3" data-id="infrastructure-phrase">→ Packages and pipelines for Foundational Health AI Research 🏗️</span>
...
::: {.fragment}
​⚡ **The Reproducibility Crisis in Clinical ML**^[[@moorEarlyPredictionSepsis2021;@fleurenMachineLearningPrediction2020a]]:​ Comparing approaches across papers is extremely hard because of differences in:
:::
...
Can we leverage continuous, multimodal data from wearable devices to improve early warning systems for postoperative complications in the general ward?
:::
::: {.fragment .fade-in}
::: {.column width="80%"}
...
- Grace period, persistence, and silencing to balance early detection with alarm fatigue.
