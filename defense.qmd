...
- **Yet Another ICU Benchmark (YAIB)**^[[@vandewaterAnotherICUBenchmark2024a]{.my-work}]: framework for reproducible ICU prediction experiments across datasets.
:::
:::
::: {.column width="30%"}
::: {.fragment data-fragment-index="3"}
...
→ Main ML expert for **largest surgical wearable-enabled** prospective cohort.
