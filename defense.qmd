...
![](figures/yaib/ext_val_mortality_pooled_auroc.svg){fig-cap="ReciPies Flow" width=85% .no-dark}
</div>
<div style="text-align: center; margin-top: -2em;">
![](figures/yaib/ext_val_mortality_pooled_auprc.svg){fig-cap="ReciPies Flow" width=85% .no-dark}
</div>
:::
...
<div style="text-align: center; margin-top: -1em;">
![](figures/yaib/transfer_learning.svg){fig-cap="" width=76% .no-dark}
</div>
<div style="text-align: center; margin-top: -2em;">
![](figures/yaib/transfer_learning_auprc.svg){fig-cap="" width=76% .no-dark}
</div>
:::
