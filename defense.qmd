...
::: {.fragment}
<div style="position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); z-index:5; width:min(90%, 30em); sans-serif; font-size: 1.5em; text-align: center; padding: 1em; border-radius: 10px; background-color: rgba(172, 172, 172, 0.95); font-weight: 700; font-family: 'Optima';">
Real-time surveillance system for patient deterioration: 

a pragmatic cluster-randomized controlled trial ^[[@rossettiRealtimeSurveillanceSystem2025]]
</div>
:::

::: {.notes}
- I’d like you to take a quick look at this slide and estimate how many people you think are represented here. Just get a number in mind.
- You probably didn’t have enough time to count—so I’ll tell you. There are 84 people on this slide.
- In a recent multicenter trial of an AI early warning system in New York City estimated that in one year, 84 people who might have died, didn’t.
...
::: {.fragment}
Results across different sample sizes:
