...
:::
::: {.column width="70%"}
- **Alarm strategy**: CASHEWS+ balances sensitivity and alarm burden
...
- Currently, the ML4H community often reinvents the wheel, and with the increasing complexity of models and data, this is becoming unsustainable.
...
- Tasks and prevalences differ widely across sites → performance comparisons must be contextualized. 
...
::: {.notes}
- Multi-modal: Clinical Notes, Pathology, Radiology, Genomics, Wearables, etc.
