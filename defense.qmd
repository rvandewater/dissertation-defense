...
::: {.columns}
::: {.column width="60%"}
- Standard static pre-ward data is not sufficient
- Remote Early Warning Score (REWS) threshold-based wearable score.
- The strongest gains came from continuous, high-resolution wearable data
- SHAP values demonstrate subtle contributions that indicate early autonomic stress
<div style="text-align: center; margin-top: -0em;">
  <img src="figures/cass/cass_performance.svg" width="100%" class="no-dark">
</div>
:::
::: {.column width="40%"}
...
- Decision curve analysis ^[[@vancalsterReportingInterpretingDecision2018]]: how much harm (diagnostics/probes) am I willing to accept?
<!-- <div style="text-align: center; margin-top: -0em;">
...
<div style="text-align: center;">
  <img src="figures/meds/meds_schema.png" width="60%" class="no-dark">
</div>
::: {.tiny-text}
...
- Use dimensionality reduction techniques (e.g., t-SNE, UMAP) to visualize the embeddings and identify clusters or patterns related to specific clinical conditions or outcomes
