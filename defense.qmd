...
- ​⚡​ Retrospective (administrative) data does not necessarily reflect the information needed for clinical decision-making.
- Reason: physiological patterns are often subtle, nonspecific, and time-varying, with substantial heterogeneity between patients^[[@roppeltArtificialIntelligenceHealthcare2024]]
- This is currently hard to detect on the sparsely monitored general ward, where most postoperative patients rehabilitate.
:::
...
<div style="text-align: center; margin-top: -5em;">
  <img src="figures/cass/fig2.svg" width="75%" class="no-dark">
</div>
...
<div style="text-align: center; margin-top: -5em;">
  <img src="figures/cass/fig5.svg" width="75%" class="no-dark">
</div>
