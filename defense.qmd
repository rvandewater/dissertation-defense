...
Eighty-four (84) lives were saved in one year by "AI".^[[@rossettiRealtimeSurveillanceSystem2025]]
...
- In a recent trial of an AI early warning system in New York City estimated that in one year, 84 people who might have died, didn’t.
...
![](icons/alert.svg){fig-cap="" height=2em .no-dark}
    <strong>Up to 25% experience life-threatening adverse events^[[@downeyImpactInhospitalPostoperative2023; @muallaImpactPostoperativeComplications2021; @baumMortalityComplicationsFollowing2019a]]</strong>
  </div>
</div>
:::
...
Can we leverage **continuous data from wearable devices** to improve warning systems for postoperative complications (surgical site infections) in the general ward? ^[[@vandewaterContinuousMultimodalAI2025]]
:::
<div style="position: relative; top: -1em;">
::: {.fragment .fade-in}
::: {.column width="55%"}
...
![](figures/meds/mount_sinai/benchmarking_mshs.svg){fig-cap="" width=100% .no-dark} ^[[@vandewaterScalingClinicalML2025; @vandewater2025flames]]
...
→ MEDS enables **AI research across health systems** with wide adoption
