...
- Dynamic baseline: REWS^[[@vanderstamWearablePatchBased2023]] threshold-based wearable score.
-  CASHEWS and wearable data improve performance.
:::
...
→ Multi-center framework for reproducible ML4H (44 cit., GH 96 ⭐).
...
{{< include "resources/people_slide_green.qmd" >}}
