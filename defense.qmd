...
**Despite the promise and explosion of AI and machine learning research, more abundant data, and advances in methodology, few models have been successfully deployed in clinical practice.** ^[[@apellExplainingSlowAdoption2026] [@henzlerHealthcareProfessionalsPerspectives2025]]
:::

Main barriers to translation:

::: {.fragment .fade-in}
⚡ <span data-id="problem-repro-shared" style="display:inline-block; font-weight:700;">Research reproducibility</span>: Different papers report different performance for the same task due to variations in datasets, preprocessing, and evaluation.^[[@futomaMythGeneralisabilityClinical2020]]
:::
::: {.fragment .fade-in}
⚡ <span data-id="problem-incomplete-shared" style="display:inline-block; font-weight:700;">Incomplete observations</span>: Retrospective data does not necessarily reflect the information needed for clinical decision-making. ^[[@agnielBiasesElectronicHealth2018]]
:::
::: {.fragment .fade-in}
⚡ <span data-id="problem-infrastructure-shared" style="display:inline-block; font-weight:700;">Lack of robust infrastructure</span>: Each institution builds their own custom solutions, making it hard to share research results and validate across sites.^[[@mcdermottLackScienceMachine2025] [@donohoDataScienceSingularity2024]]
:::
::: {.fragment .fade-in}
*Out of scope: ​⚡​ ** Ethical and regulatory hurdles**: Proving patient safety and privacy, fairness, and clinical utility to governance bodies is challenging.^[[@vancalsterThereNoSuch2023]] *
:::
...
1. ⚡ <span data-id="problem-repro-shared" style="display:inline-block; font-weight:700;">Research reproducibility</span> <span class="fragment fade-in" data-fragment-index="1" data-id="repro-phrase">→ Enabling Reproducible Prediction Experiments 🧪</span>
2. ⚡ <span data-id="problem-incomplete-shared" style="display:inline-block; font-weight:700;">Incomplete observations</span>  <span class="fragment fade-in" data-fragment-index="2" data-id="incomplete-phrase">→ Development of Multi-ward Multi-modal Warning Systems 🛏️​</span>
3. ⚡ <span data-id="problem-infrastructure-shared" style="display:inline-block; font-weight:700;">Lack of robust infrastructure</span>  <span class="fragment fade-in" data-fragment-index="3" data-id="infrastructure-phrase">→ Tools and Pipelines for Foundational Health AI Research 🏗️</span>
...
architecture."* ^[[@marianoGlobalStrategyDigital2020]]</span>
:::
::: {.column width="20%"}
...
<div data-id="recipies-logo-box" style="position:absolute; right:2%; top:86%; width:12%; text-align:right;">
  <img src="figures/yaib/recipies_logo.svg" style="width:100%;" class="no-dark">
</div>
