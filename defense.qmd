...
::: {.notes}
- I’d like you to take a look and estimate how many people you think are on this slide. Just get a number in mind.
- You probably didn’t have enough time to count—so I’ll tell you. There are 84 people on this slide.
...
→ Harmonizing data can provide **off-the-shelf** tunable models.
...
→ Expanded MEDS-DEV; 9 datasets

→ **Adoption** across the community (87 agg. cit.; 113 GH followers).
:::
:::
:::
<div class="fragment fade-out" data-fragment-index="2" style="position:absolute; top:7%; left:23%; width:100%; height:45%; background:white;"></div>
<div class="fragment fade-out" data-fragment-index="3" style="position:absolute; top:7%; left:60%; width:100%; height:45%; background:white;"></div>
...
```{=html}
<style>
.reveal .slides section{overflow:visible!important}
...
- Comittee: Christoph Lippert, Lothar Wieler, Felix Naumann, Gerard de Melo
- Executive assistents: Edit Tatar, Cornelia Philippson, Katharina Lorenz-Schroeder, Lena Kaese.
