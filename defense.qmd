...
::: {.notes}
Coming back to the those 84 patients that we started with, we can see that this could just be the beginning of AI in healthcare. By closing the reproducibility gap, we can enable more collaborative research across institutions and datasets. This should lead to  prolonged patient lives through trustworthy and equitable healthcare AI for the many.
<!-- 
