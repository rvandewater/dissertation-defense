...
::: {.fragment}
​⚡ **The Reproducibility Crisis in Clinical ML**:​ Comparing approaches across papers is extremely hard because of differences in:
:::
...
Individual research results (models, techniques, ideas) do not generalize accross settings, hindering meaningful scientific progress and clinical translation. ^[[@moorEarlyPredictionSepsis2021;@fleurenMachineLearningPrediction2020a]]
:::
...
- Each site/dataset independently trains and evaluates on their own MEDS data:
